    ...
    switch (response.statusCode) {
      case 200:
        if (response.body.toString().isNotEmpty) {
          ...
          throw NoDataException(S.current.noKittens);
        }
      case 201:
        throw UnauthorisedException(S.current.unauthorised);
      case 400:
        throw BadRequestException(S.current.badRequest);
      case 500:
        throw ServerException(S.current.serverError);
      default:
        throw NoDataException(S.current.unexpectedError);
    }
  }
}
